...
--
-- Servidor: localhost
-- Tiempo de generación: 02-07-2024 a las 20:50:47
...
--
-- Estructura de tabla para la tabla `moviestags`
--

CREATE TABLE `moviestags` (
  `ID_MoviesTags` int(11) NOT NULL,
  `ID_Movie_FK` int(11) DEFAULT NULL,
...
--
-- Indices de la tabla `moviestags`
--
...
--
-- AUTO_INCREMENT de la tabla `moviestags`
--
ALTER TABLE `moviestags`
  MODIFY `ID_MoviesTags` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `moviestags`
--
ALTER TABLE `moviestags`
  ADD CONSTRAINT `MovieTags_Tag` FOREIGN KEY (`ID_Tag_FK`) REFERENCES `tags` (`ID_Tag`),
  ADD CONSTRAINT `MoviesTags_Movies` FOREIGN KEY (`ID_Movie_FK`) REFERENCES `movies` (`ID`);
